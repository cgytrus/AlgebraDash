...
PROFILER_HOOK_SAME_ARGS(GD + 0x11e1d0, void, __vectorcall, gd::GJEffectManager::updateColorEffects, (self, _xmm0, dt), void* self, float _xmm0, float dt)
PROFILER_HOOK_SAME_ARGS(GD + 0x11e7f0, void, __vectorcall, gd::GJEffectManager::updatePulseEffects, (self, _xmm0, dt), void* self, float _xmm0, float dt)
PROFILER_HOOK_SAME_ARGS(GD + 0x11e490, void, __vectorcall, gd::GJEffectManager::updateOpacityEffects, (self, _xmm0, dt), void* self, float _xmm0, float dt)
PROFILER_HOOK_SAME_ARGS(GD + 0x11f000, void, __vectorcall, gd::GJEffectManager::updateSpawnTriggers, (self, _xmm0, dt), void* self, float _xmm0, float dt)
PROFILER_HOOK_THIS(GD + 0x11d030, void, gd::GJEffectManager::preCollisionCheck)
//PROFILER_HOOK_SAME_ARGS(GD + 0x11da30, void, __vectorcall, gd::GJEffectManager::prepareMoveActions, (self, _xmm0, steps, idk), void* self, float _xmm0, float steps, bool idk)
PROFILER_HOOK_SAME_ARGS(GD + 0x10ffa0, void, __vectorcall, gd::GJBaseGameLayer::processMoveActionsStep, (self, _xmm0, steps), void* self, float _xmm0, float steps)
PROFILER_HOOK_THIS(GD + 0x1101a0, void, gd::GJBaseGameLayer::processRotationActions)
PROFILER_HOOK_THIS(GD + 0x1107e0, void, gd::GJBaseGameLayer::processMoveActions)
PROFILER_HOOK_SAME_ARGS(GD + 0x110b10, void, __vectorcall, gd::GJBaseGameLayer::processPlayerFollowActions, (self, _xmm0, dt), void* self, float _xmm0, float dt)
...
PROFILER_HOOK_SAME_ARGS(GD + 0x2071d0, void, __vectorcall, gd::PlayLayer::updateCamera, (self, _xmm0, dt), void* self, float _xmm0, float dt)
PROFILER_HOOK_THIS(GD + 0x205460, void, gd::PlayLayer::updateVisibility)
PROFILER_HOOK_THIS(GD + 0x203a90, void, gd::PlayLayer::updateLevelColors)
PROFILER_HOOK_THIS(GD + 0x208020, void, gd::PlayLayer::updateProgressbar)
PROFILER_HOOK_THIS(GD + 0x20aab0, void, gd::PlayLayer::updateEffectPositions)
