...
PROFILER_HOOK_THIS(GD + 0x1101a0, void, gd::PlayLayer::FUN_005101a0)
PROFILER_HOOK_THIS(GD + 0x1107e0, void, gd::PlayLayer::FUN_005107e0)
PROFILER_HOOK_THIS(GD + 0x110b10, void, gd::PlayLayer::FUN_00510b10)
PROFILER_HOOK_THIS(GD + 0x110e00, void, gd::PlayLayer::FUN_00510e00)
...
PROFILER_HOOK_THIS_ARGS(GD + 0x2531f0, void, gd::AnimatedGameObject::updateChildSpriteColor, (self, idk), int idk)
...
PROFILER_HOOK_THIS_ARGS(GD + 0xef0e0, void, gd::GameObject::activateObject, (self, idk), void* idk)
...
PROFILER_HOOK_THIS_ARGS(COCOS2DSYM("?update@CCAccelerometer@cocos2d@@QAEXNNNN@Z"), void, cocos2d::CCAccelerometer::update, (self, dt), float dt)
